import type { RespostaDocumento } from "../../shared/types";

const parametros = new URLSearchParams(window.location.search);
export const idDocumento = parametros.get("id") ?? "";

const elemTituloDocumento = document.getElementById(
  "titulo-documento",
) as HTMLHeadingElement | null;
export const elemEditorTexto = document.getElementById(
  "editor-texto",
) as HTMLTextAreaElement | null;
export const elemBotaoExcluir = document.getElementById(
  "excluir-documento",
...
export const tratarExibicaoDocumento = (resposta: RespostaDocumento) => {
